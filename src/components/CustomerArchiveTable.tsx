...
export default function CustomerArchiveTable({ customers }: { customers: ArchivedCustomer[] }) {
    ...
    if (!data) {
      toast.error(
        pendingAction.type === "purge"
          ? "Müşteri 30 günlük bekleme süresini henüz doldurmamış."
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end gap-2">
                        ...
                        <button
                          ...
                          title={purgeEligible ? "Kalıcı sil" : "Kalıcı silme için 30 gün beklenmelidir"}
            ...
            <div key={customer.id} className="space-y-3 p-4" data-testid={`archived-customer-mobile-${customer.id}`}>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  title={customer.purge_eligible ? "Kalıcı sil" : "Kalıcı silme için 30 gün beklenmelidir"}
