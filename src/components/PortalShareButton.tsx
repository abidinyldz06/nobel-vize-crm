...
export default function PortalShareButton({ customer }: PortalShareButtonProps) {
  ...
  const portalUrl = token ? `${baseUrl}/portal/${token}` : "";
            ...
            <div className="p-6 overflow-y-auto">
              {!token ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 font-medium text-sm">Bu müşteri için henüz bir portal linki bulunmuyor. Lütfen önce yenile butonuna basarak link oluşturun.</p>
                </div>
              ) : (
                <>
