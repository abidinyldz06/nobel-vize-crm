    ...
    <aside className="w-60 flex flex-col h-screen sticky top-0 z-40 bg-white dark:bg-[#0d1420] border-r border-slate-200 dark:border-[#1f2937]">
      ...
      <div className="px-3 py-4 border-t border-slate-200 dark:border-[#1f2937] space-y-1">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-600 to-purple-600 flex items-center justify-center text-slate-900 dark:text-white text-xs font-bold shrink-0">N</div>
          <div className="min-w-0">
            <p className="text-sm font-medium text-slate-900 dark:text-slate-200 truncate">Nobel Vize</p>
