...
export default async function SettingsPage({
  ...
  const [
    ...
    supabase.from('tenants').select('id, company_name, email, phone, contact_source_url, contact_verified_at, contact_verified_by_staff_id, admin_mfa_required, consultant_mfa_required, created_at').single(),
