-- Faz 3.4.6: musteri etiketlerini backup v2 kapsaminda korur.
-- Eski v2 yedeklerinde etiket anahtarlari olmayabilir; geriye uyumludur.
...
BEGIN
  ...
  FOREACH table_name IN ARRAY ARRAY['tasks', 'notifications', 'tags', 'customer_tags'] LOOP
