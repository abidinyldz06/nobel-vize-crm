-- Faz 1 migration sonrasi veri kalite sayaclari. Tum degerler sifir olmadan
-- NOT VALID constraint'ler production'da VALIDATE edilmemelidir.
...
UNION ALL
SELECT 'activity_logs_without_actor_fk', count(*)
FROM public.activity_log
WHERE performed_by_staff_id IS NULL AND performed_by <> 'Sistem'
ORDER BY check_name;
